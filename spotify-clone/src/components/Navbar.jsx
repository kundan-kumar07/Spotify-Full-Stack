  ...
  return (
    ...
    <div className='w-full flex justify-between items-center font-semibold'>
      ...
      <div className='flex items-center gap-4'>
        ...
        <p className='bg-black pu-1 px-3 rounded-full text-[15px] cursor-pointer '>Install App</p>
        <p className='bg-purple-500 text-black w-7 h-7 rounded-2xl flex items-center justify-center'>K</p>
      </div>
    </div>
